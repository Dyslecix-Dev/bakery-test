...
import { BrickBackgroundProps } from "@/types/props";

export default function BrickBackground({ patternColor = "#f58891", backgroundColor = "transparent", className, fade = true, style, ...props }: BrickBackgroundProps) {
